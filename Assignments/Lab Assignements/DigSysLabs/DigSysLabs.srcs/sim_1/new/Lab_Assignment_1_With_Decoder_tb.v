...
//    #10;
    ...
    sel = 3'b000; // Encoding: 3
    number = 5'b11110; // Decimal equivalent: 21
    #10;
    // Example 2
    sel = 3'b001; // Encoding: 7
    number = 5'b11110; // Decimal equivalent: 27
    #10;
    // Example 3
    sel = 3'b010; // Enciding: 6
    number = 5'b11110; // Decimal equivalent: 4
    #10;
    // Example 4
    sel = 3'b011; // Enciding: 8
    number = 5'b11110; // Decimal equivalent: 29
    #10;
    
    sel = 3'b000; // Encoding: 3
    number = 5'b10100; // Decimal equivalent: 21
    #10;
    // Example 2
    sel = 3'b001; // Encoding: 7
    number = 5'b10100; // Decimal equivalent: 27
    #10;
    // Example 3
    sel = 3'b010; // Enciding: 6
    number = 5'b10100; // Decimal equivalent: 4
    #10;
    // Example 4
    sel = 3'b011; // Enciding: 8
    number = 5'b10100; // Decimal equivalent: 29
    #10;
